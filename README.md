...
This mod adds various light sources demonstrating the power of the [LambDynamicLights] API, while still adding some really cool features to the game.

You need to install LambDynamicLights ([Modrinth page](https://modrinth.com/mod/lambdynamiclights)<!-- modrinth_exclude.start --> / [CurseForge page](https://www.curseforge.com/minecraft/mc-mods/lambdynamiclights)<!-- modrinth_exclude.end -->) along with this mod.
...
A flashlight, making a light shape normally impossible in Minecraft. Ideal for horror themed events, maps or packs.

![lighting up a creaking](assets/flashlight_demo.png)

It can be crafted as so:

![crafting recipe](assets/flashlight_recipe.png)

The flashlight can be toggled on and off by right-clicking.

## 📖 I want to use this API as well!

[Check out this in-depth documentation for LambDynamicLights](https://lambdaurora.dev/projects/lambdynamiclights/docs/v4/).

<!-- modrinth_exclude.long_start -->
## 💾 Downloads

<div>
<a href="https://modrinth.com/mod/illuminated" style="display: inline-flex; align-items: center;">
...
<a href="https://www.curseforge.com/minecraft/mc-mods/illuminated" style="display: inline-flex; align-items: center">
...
<span style="display: inline-block; width: 1em"></span>
<a href="https://github.com/LambdAurora/Illuminated/releases" style="display: inline-flex; align-items: center">
...
[LambDynamicLights]: https://lambdaurora.dev/projects/lambdynamiclights
